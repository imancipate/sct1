...
add_action( 'load-post.php', 'selfcare__wpcf_usermeta_test', 999999999999999999999 );
add_action( 'load-post-new.php', 'selfcare__wpcf_usermeta_test', 999999999999999999999 );
if ( is_admin() ) {
    add_filter( 'wpcf_post_groups', 'selfcare__wpcf_usermeta_test_groups' );
}

function selfcare__wpcf_usermeta_test() {
...
function selfcare__wpcf_usermeta_test_groups( $groups ) {
    if ( !empty( $groups ) ) {
        return $groups;
    }
