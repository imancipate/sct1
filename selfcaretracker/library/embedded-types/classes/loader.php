...
class WPCF_Loader
{
    ...
    public static function init( $settings = array() ) {
        ...
        self::selfcare__registerScripts();
        self::selfcare__registerStyles();
        self::selfcare__toolset();
     ...
     * Register scripts.
     */
    private static function selfcare__registerScripts() {
...
//                array('types-jquery-validation-additional'), WPCF_VERSION, true );
     ...
     * Register styles.
     */
    private static function selfcare__registerStyles() {
     ...
     * Toolset loading.
     */
    private static function selfcare__toolset() {
        // Views
