...
// Add sorting
        ...
        if ( $this->data['fields_setting'] == 'specific'
            ...
            foreach ( $this->data['fields'] as $field_key => $true ) {
                ...
                if ( in_array( $field_key,
                     ...
                     * Set field
                     */
                    $field_key = $this->cf->selfcare__get_slug_no_prefix( $field_key );
    ...
    function field_form() {
         ...
         * Filter form
         */
        $_filtered_form = $this->selfcare__filter_meta_form( $form );
     ...
     * @return string
     */
    function selfcare__filter_meta_form( $form = array() ) {
        foreach ( $form as $k => &$e ) {
            /*
             * 
             * Filter name
