...
function wpcf_fields_date_conditional_value_filter( $value, $field, $operation,
    ...
    $field = wpcf_admin_fields_get_field( $wpcf->field->selfcare__get_slug_no_prefix( $field ) );
...
function wpcf_fields_date_custom_conditional_statement_filter( $null,
    ...
    $field = wpcf_admin_fields_get_field( $wpcf->field->selfcare__get_slug_no_prefix( $meta_key ) );
 ...
 * @param type $field
 */
function selfcare__wpcf_fields_date_check_leftover( $value, $field, $use_cache = true ) {
